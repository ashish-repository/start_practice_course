# Steps to Start Practice Course with Cloudops

## ✅ PART 1 — Create ONE GitHub Repository
# 1. Go to [github.com](https://github.com)
# 2. Login
# 3. Click `+` (top right) → New repository
# 4. Repository name: `Batch_Name_Cloudops` (e.g., `Mar2026_ashish_Cloudops`)
# 5. Select **Public**
...
Note: If you already have a repository then don't create new repository.

---

## ✅ PART 2 — Prepare Local Files (On Your Laptop)
Install Gitbash in your Laptop/Local Machine
Create a folder on desktop as "workspace".
Go inside the workspace folder and right click and open gitbash here
...
mkdir Batch_Name_Cloudops
cd Batch_Name_Cloudops
...
git remote add origin https://github.com/your-username/Batch_Name_Cloudops.git
